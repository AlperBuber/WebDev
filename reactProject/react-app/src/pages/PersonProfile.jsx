...
const PersonProfile = () => {
  ...
  return (
    <div className="container">
      <div className="row">
        <div className="aside col-3 mt-4">
          ...
          <div className="actor-personal-details">
        ...
        <div className="actor-details col-9 mt-4">
          <div className="actor-name">
            <h2 className="fw-bold text-black">{actor?.name}</h2>
          </div>
          <div className={`actor-bio ${bioOverFlow ? "expanded" : ""}`}>
            <h4 className="fw-bold text-black">Biyografi</h4>
            <p className="">
              {actor?.biography
                ? actor?.biography
          ...
          <div className="actor-other-movies">
            <p className="fw-bolder h5 mt-5">{`More movies by ${actor.name}`}</p>
                          ...
                          >
                            <div className="">
                              <img
                                ...
                                style={{ height: "200px" }}
                              />
                              <p className="text-black hover ">{movie.title}</p>
                            </div>
                          </Link>
                        </div>
                      );
